...
app.secret_key = os.environ.get('FLASK_SECRET_KEY', 'a_very_secret_key_for_session_management') # Replace with a strong, random key
...
def send_metrics_to_ml_backend(expiry_date, db_file):
...
@app.route('/manual_auth', methods=['POST'])
